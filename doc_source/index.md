...
+ [Working with AWS License Manager](using-license-manager.md)
   ...
   + [Linux subscriptions in AWS License Manager](linux-subscriptions.md)
...
+ [Monitoring AWS License Manager](monitoring-overview.md)
...
+ [Security in AWS License Manager](security.md)
   ...
   + [Using service-linked roles for AWS License Manager](using-service-linked-roles.md)
      ...
      + [License Manager – Linux subscriptions role](linux-subscriptions-role.md)
